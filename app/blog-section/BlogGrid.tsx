  ...
  return (
    <section className="z-10 flex w-full flex-col items-center justify-center overflow-hidden bg-[#0E1016] bg-cover bg-center pt-20 md:pb-16 lg:pb-32">
      ...
      >
        ...
        />
        <AnimatedBody
          text="Professional experience building production-grade applications and creating impactful digital content."
          className="w-[90%] text-center text-[14px] font-semibold uppercase sm:w-[500px] md:w-[550px] md:text-[16px]"
        />
      </div>
      <div className="grid w-[90%] max-w-[1200px] grid-cols-1 gap-x-6 gap-y-6 md:grid-cols-2">
